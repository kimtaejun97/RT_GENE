...
path = '../mtcnn_twoeyes_inpainted_eccv'
...
# Parameters
#논문 learning rate:0.00005, beta1: 0.9, beta2: 0.999, batch 128, 100epoch
...
for subjects_train, subjects_test in zip(subjects_train_threefold, subjects_test_threefold):
    ...
    train_files = [io.loadmat(train_file_name) for train_file_name in train_file_names]
    ...
    adam = Adam(lr=0.00005, beta_1=0.9, beta_2=0.999)
