...
if __name__ == "__main__":
    ...
    root_parser.add_argument('--hdf5_file', type=str, default=os.path.abspath(os.path.join(root_dir, "../rt_gene_dataset/rtgene_dataset.hdf5")))
...
if ensemble:
    ...
    hyperparams.model_loc = hyperparams.model_loc[0]
    ...
    for fold_idx, (test_subject, fold) in enumerate(zip(test_subjects, folds)):
        ...
        epoch_ckpt = glob.glob(os.path.abspath(os.path.join(fold, "*.model")))
