...
if __name__ == "__main__":
    ...
    _root_parser.add_argument('--ckpt_dir', type=str, default=os.path.abspath(os.path.join(root_dir, '../model_nets/pytorch_checkpoints/Test/')))
    _root_parser.add_argument('--save_dir', type=str, default=os.path.abspath(os.path.join(root_dir, '../model_nets/pytorch_models/Test')))
